...
#include "RecoMuon/GlobalMuonProducer/src/SamarMuonProducer.h"
...
//
SamarMuonProducer::SamarMuonProducer(const ParameterSet& parameterSet) {
...
// destructor
//
SamarMuonProducer::~SamarMuonProducer() {
...
// reconstruct muons
//
void SamarMuonProducer::produce(Event& event, const EventSetup& eventSetup) {
 ...
 cout << "string_SAMAR :"<< testCollectionLabel_ << endl; 
