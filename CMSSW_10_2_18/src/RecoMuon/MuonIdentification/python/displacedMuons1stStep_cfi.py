...
displacedMuons1stStep = cms.EDProducer("MuonIdProducer",
   ...
   #inputCollectionLabels = cms.VInputTag(cms.InputTag("displacedTracks"), cms.InputTag("globalMuons"), cms.InputTag("displacedStandAloneMuons"),
    ...
    inputCollectionLabels = cms.VInputTag(cms.InputTag("displacedTracks"), cms.InputTag("samarMuons"), cms.InputTag("displacedStandAloneMuons")),

    #inputCollectionLabels = cms.VInputTag(cms.InputTag("generalTracks"), cms.InputTag("globalMuons"), cms.InputTag("standAloneMuons","UpdatedAtVtx")),
    #                                      cms.InputTag("displacedTracks"), cms.InputTag("displacedGlobalMuons"), cms.InputTag("displacedStandAloneMuons")),
    ...
    globalTrackQualityInputTag = cms.InputTag('displacedGlbTrackQual'), ##samar
...
#run3_GEM.toModify( displacedMuons1stStep, TrackAssociatorParameters = dict(useGEM = cms.bool(True) ) )
#from Configuration.Eras.Modifier_phase2_muon_cff import phase2_muon
#phase2_muon.toModify( displacedMuons1stStep, TrackAssociatorParameters = dict(useME0 = cms.bool(True) ) )
...
#pp_on_AA_2018.toModify(displacedMuons1stStep, minPt = 0.8)
