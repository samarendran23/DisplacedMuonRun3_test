#ifndef RecoMuon_MuonIdentification_displacedMuonProducer_H
#define RecoMuon_MuonIdentification_displacedMuonProducer_H
...
public:
  ...
  /// Constructor
  displacedMuonProducer(const edm::ParameterSet&);

  /// Destructor
  ~displacedMuonProducer() override;
