/** \class displacedMuonProducer
 *  See header file.
 *
 *  \author R. Bellan - UCSB <riccardo.bellan@cern.ch>
 */

#include "RecoMuon/MuonIdentification/plugins/displacedMuonProducer.h"
...
/// Constructor
displacedMuonProducer::displacedMuonProducer(const edm::ParameterSet& pSet):debug_(pSet.getUntrackedParameter<bool>("ActivateDebug",false)){
...
/// reconstruct muons
void displacedMuonProducer::produce(edm::Event& event, const edm::EventSetup& eventSetup){

   const std::string metname = "Muon|RecoMuon|MuonIdentification|displacedMuonProducer";
...
void displacedMuonProducer::fillMuonMap(edm::Event& event,
...
std::string displacedMuonProducer::labelOrInstance(const edm::InputTag &input) const{
