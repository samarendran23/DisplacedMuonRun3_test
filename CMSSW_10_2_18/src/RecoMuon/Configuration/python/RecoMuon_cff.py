...
muonshighlevelrecoTask = cms.Task(muonPFIsolationTask,muons,displacedMuons) ##samar
#muonshighlevelrecoTask = cms.Task(muonPFIsolationTask,displacedMuonPFIsolationTask,muons,displacedMuons) ##samar
