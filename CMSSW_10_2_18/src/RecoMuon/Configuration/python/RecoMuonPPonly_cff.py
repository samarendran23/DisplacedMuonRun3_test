...
#samarMuons
#from RecoMuon.GlobalMuonProducer.samarMuons_cfi import *   ####samar added 
...
from RecoMuon.MuonIdentification.displacedMuonSelectionTypeValueMapProducer_cff import * ##samar

#from RecoMuon.MuonIdentification.displacedmuonSelectionTypeValueMapProducer_cff import *
...
globalmuontrackingTask = cms.Task(globalMuons,samarMuons,tevMuons,displacedGlobalMuonTrackingTask) ##Added samar 
#globalmuontrackingTask = cms.Task(samarMuons,globalMuons,tevMuons,displacedGlobalMuonTrackingTask) ##Added samar
